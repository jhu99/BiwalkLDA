...
%% load data
LD=importdata('../Datasets/Dataset3/interMatrix.mat');
lncSim=importdata('../Datasets/Dataset3/lncSim.mat');    
dissim=importdata('../Datasets/Dataset3/disSim_Jaccard.mat');
...
for foldID = 1 : Nint
    ...
    M_recover = birandom(interaction,dissim, 0.78,5,5); 
    %% calculate AUC
